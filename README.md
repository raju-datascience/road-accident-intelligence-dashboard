...
This project transforms structured traffic accident data into **actionable risk intelligence** using **Python, MySQL (Star Schema), and Power BI**.

The objective goes beyond visualization — it focuses on identifying:

- High-risk locations  
- Time-based accident patterns  
- Infrastructure & environmental risk factors  
